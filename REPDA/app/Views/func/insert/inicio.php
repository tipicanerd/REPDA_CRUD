<section>
    ...
    <h4>
        En este apartado podrás insertar nuevas concesiones, así como los aprovechamientos de aguas nacionales que las mismas amparan.<br>

        Para ello, basta con seleccionar lo que deseas agregar y posteriormente rellenar los campos solicitados.
    </h4>
	...
	<form method="post" action="http://localhost/BDA2022/REPDA/index.php/Insertion/concesion">
		<h4>Título <input type="text" name="titulo" required maxlength="20"></h4> 
		<h4>Titular <input type="text" name="titular" required maxlength="255"></h4> 
		...
		<h4>Autoridad que emite el registro <input type="text" required name="autoridad" maxlength="255"></h4>
		<input type="submit" name="send" style="background-color: rgb(110,207,253); font-size: 16px; border-radius: 12px; border-style: groove;" value="Registrar"> 
	</form>
	</div>
	...
	<form method="post" action="http://localhost/BDA2022/REPDA/index.php/Insertion/descarga">
		...
		<h4>Procedencia <input list="procedencias" name="procedencia" required placeholder = "Selecciona una procedencia">
        ...
        <h4>Cuerpo receptor <input list="cuerpos" name="cuerpo_receptor" placeholder = "Selecciona un cuerpo receptor" required>
			<datalist id="cuerpos">
            <?php
        ...
        <h4>Longitud <input type="number" required name="longitud" step="0.001"></h4>	
        <h4>Latitud <input type="number" required name="latitud" step="0.001"></h4>
        <h4>Afluente al que se descarga <input list="afluentes" required name="afluente" placeholder = "Selecciona un afluente">
        ...
        <h4>Forma de descarga <input list="formas" name="forma" required placeholder = "Selecciona una forma de descarga">
			<datalist id="formas">
            <?php
        ...
        <h4>Tipo de descarga <input list="tipos_des" required name="tipo_des" placeholder = "Selecciona un tipo de descarga">
        ...
        <h4>
            Estado
            <input list="estados" name="estado" required placeholder = "Selecciona un estado">
			<datalist id="estados">
            <?php
        ...
        <h4>
            Municipio
            <input list="municipios" name="municipio" required placeholder = "Selecciona un municipio">
        ...
        <h4>
            Cuenca
            <input list="cuencas" name="cuenca" required placeholder = "Selecciona una cuenca">
			<datalist id="cuencas">
            <?php
	...
	<form method="post" action="http://localhost/BDA2022/REPDA/index.php/Insertion/subte">
		<h4>Título <input list="titulos" required name="titulo" placeholder = "Selecciona un titulo">
			<datalist id="titulos">
            <?php
                foreach($Concesiones as $item){
                    $nombre = $item['titulo'];
	...
	<form method="post" action="http://localhost/BDA2022/REPDA/index.php/Insertion/sup">
		<h4>Título <input list="titulos" name="titulo" required placeholder = "Selecciona un titulo">
			<datalist id="titulos">
            <?php
                foreach($Concesiones as $item){
	...
	<form method="post" action="http://localhost/BDA2022/REPDA/index.php/Insertion/zona">
		<h4>Título <input list="titulos" name="titulo" required placeholder = "Selecciona un titulo">
			<datalist id="titulos">
            <?php
                foreach($Concesiones as $item){
        ...
        <h4>Longitud <input type="number" name="longitud" required step="0.001"></h4>	
        <h4>Latitud <input type="number" name="latitud" required step="0.001"></h4>
        <h4>
            Estado
            <input list="estados" name="estado" required placeholder = "Selecciona un estado">
			<datalist id="estados">
        ...
        <h4>
            Corriente
            <input list="corrientes" name="corriente" required placeholder = "Selecciona una corriente">
        ...
        <h4>Superficie (m²) <input type="number" required name="superficie" step="0.001"></h4>
		<input type="submit" name="send" style="background-color: rgb(110,207,253); font-size: 16px; border-radius: 12px; border-style: groove;" value="Registrar"> 
	</form>
	</div>
